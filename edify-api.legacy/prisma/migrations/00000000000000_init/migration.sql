...
-- CreateEnum
CREATE TYPE "MonthlyWorkPlanBudgetStatus" AS ENUM ('draft_generated', 'cd_review', 'admin_plan_added', 'submitted_to_rvp', 'approved_by_rvp', 'returned_by_rvp', 'sent_to_accountant', 'disbursed', 'closed');
...
CREATE TABLE "EvidenceRecord" (
    ...
    "previewStatus" TEXT NOT NULL DEFAULT 'not_required',
    "pdfRenditionStorageKey" TEXT,
    "pdfRenditionStatus" TEXT,
    "pdfRenditionError" TEXT,
    "pdfRenditionAt" TIMESTAMP(3),
...
-- CreateTable
CREATE TABLE "FundRequestItem" (
    "id" TEXT NOT NULL,
    "fundRequestId" TEXT NOT NULL,
    "activityId" TEXT NOT NULL,
    "activityScheduleCostLineId" TEXT NOT NULL,
    "amount" DOUBLE PRECISION NOT NULL,
    "period" "FundRequestPeriod" NOT NULL,
    "periodKey" TEXT NOT NULL,
    "addedAfterGeneration" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "FundRequestItem_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "MonthlyWorkPlanBudget" (
    "id" TEXT NOT NULL,
    "fy" TEXT NOT NULL,
    ...
    "generatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "generatedBy" TEXT,
    "status" "MonthlyWorkPlanBudgetStatus" NOT NULL DEFAULT 'draft_generated',
    "programTotal" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "adminTotal" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "activityCount" INTEGER NOT NULL DEFAULT 0,
    "submittedAt" TIMESTAMP(3),
    "submittedByUserId" TEXT,
    "rvpReviewedAt" TIMESTAMP(3),
    "rvpReviewedByUserId" TEXT,
    "rvpReviewNote" TEXT,
    "sentToAccountantAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "MonthlyWorkPlanBudget_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "MonthlyWorkPlanItem" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "MonthlyWorkPlanItem_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "AdminBudgetLine" (
    "id" TEXT NOT NULL,
    "monthlyBudgetId" TEXT NOT NULL,
    ...
    CONSTRAINT "AdminBudgetLine_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BudgetRevision" (
    "id" TEXT NOT NULL,
    "activityId" TEXT NOT NULL,
    "activityScheduleCostLineId" TEXT,
    "fromFy" TEXT NOT NULL,
    "fromQuarter" TEXT NOT NULL,
    "fromMonth" INTEGER,
    "fromWeek" INTEGER,
    "toFy" TEXT NOT NULL,
    "toQuarter" TEXT NOT NULL,
    "toMonth" INTEGER,
    "toWeek" INTEGER,
    "fundRequestId" TEXT,
...
-- CreateIndex
CREATE INDEX "EvidenceRecord_previewStatus_idx" ON "EvidenceRecord"("previewStatus");
...
-- CreateIndex
CREATE UNIQUE INDEX "FundRequest_submittedByUserId_period_periodKey_key" ON "FundRequest"("submittedByUserId", "period", "periodKey");
...
-- CreateIndex
CREATE INDEX "FundRequestItem_activityId_idx" ON "FundRequestItem"("activityId");

-- CreateIndex
CREATE INDEX "FundRequestItem_fundRequestId_idx" ON "FundRequestItem"("fundRequestId");

-- CreateIndex
CREATE UNIQUE INDEX "FundRequestItem_fundRequestId_activityScheduleCostLineId_key" ON "FundRequestItem"("fundRequestId", "activityScheduleCostLineId");

-- CreateIndex
CREATE UNIQUE INDEX "FundRequestItem_activityScheduleCostLineId_period_periodKey_key" ON "FundRequestItem"("activityScheduleCostLineId", "period", "periodKey");

-- CreateIndex
CREATE INDEX "MonthlyWorkPlanBudget_status_idx" ON "MonthlyWorkPlanBudget"("status");

-- CreateIndex
CREATE INDEX "MonthlyWorkPlanBudget_fy_monthKey_idx" ON "MonthlyWorkPlanBudget"("fy", "monthKey");

-- CreateIndex
CREATE UNIQUE INDEX "MonthlyWorkPlanBudget_countryId_monthKey_key" ON "MonthlyWorkPlanBudget"("countryId", "monthKey");

-- CreateIndex
CREATE INDEX "MonthlyWorkPlanItem_activityId_idx" ON "MonthlyWorkPlanItem"("activityId");

-- CreateIndex
CREATE UNIQUE INDEX "MonthlyWorkPlanItem_monthlyBudgetId_activityScheduleCostLin_key" ON "MonthlyWorkPlanItem"("monthlyBudgetId", "activityScheduleCostLineId");

-- CreateIndex
CREATE INDEX "AdminBudgetLine_monthlyBudgetId_idx" ON "AdminBudgetLine"("monthlyBudgetId");

-- CreateIndex
CREATE INDEX "BudgetRevision_activityId_idx" ON "BudgetRevision"("activityId");

-- CreateIndex
CREATE INDEX "BudgetRevision_fundRequestId_idx" ON "BudgetRevision"("fundRequestId");

-- CreateIndex
CREATE INDEX "BudgetRevision_monthlyBudgetId_idx" ON "BudgetRevision"("monthlyBudgetId");
...
-- AddForeignKey
ALTER TABLE "FundRequestItem" ADD CONSTRAINT "FundRequestItem_fundRequestId_fkey" FOREIGN KEY ("fundRequestId") REFERENCES "FundRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MonthlyWorkPlanItem" ADD CONSTRAINT "MonthlyWorkPlanItem_monthlyBudgetId_fkey" FOREIGN KEY ("monthlyBudgetId") REFERENCES "MonthlyWorkPlanBudget"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AdminBudgetLine" ADD CONSTRAINT "AdminBudgetLine_monthlyBudgetId_fkey" FOREIGN KEY ("monthlyBudgetId") REFERENCES "MonthlyWorkPlanBudget"("id") ON DELETE CASCADE ON UPDATE CASCADE;
