...
urlpatterns = [
    ...
    path("<str:school_id>/next-actions", views.SchoolNextActionsView.as_view(), name="next-actions"),
    path("<str:school_id>/cluster", views.SchoolClusterAssignView.as_view(), name="cluster"),
    path("<str:school_id>/type", views.SchoolTypeView.as_view(), name="type"),
    path("<str:school_id>/resolve-duplicate", views.SchoolResolveDuplicateView.as_view(), name="resolve-duplicate"),
]
