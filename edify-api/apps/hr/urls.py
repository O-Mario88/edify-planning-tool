...
urlpatterns = [
    ...
    path("leave/<str:leave_id>/approve", views.LeaveApproveView.as_view(), name="leave-approve"),
    path("leave/<str:leave_id>/reject", views.LeaveRejectView.as_view(), name="leave-reject"),
]
