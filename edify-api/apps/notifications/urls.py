...
urlpatterns = [
    ...
    path("<str:notification_id>/read", views.NotificationReadView.as_view(), name="read"),
    path("<str:notification_id>/resolve", views.NotificationResolveView.as_view(), name="resolve"),
]
