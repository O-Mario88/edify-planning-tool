...
| /accounts/accountability/ | Accountability Tracking - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/accountability.html | 9.3 | 1 | referenced by automated test |
| /accounts/activities/<str:activity_id> | Activity Finance Detail - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/activity_finance_detail.html | 9.6 | 1 | referenced by automated test |
| /accounts/activities/<str:activity_id>/ | Activity Finance Detail - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/activity_finance_detail.html | 9.6 | 1 | referenced by automated test |
...
| /accounts/activity-evidence/<str:activity_id> | Activity Evidence Review | ACCOUNTANT, ADMIN | pages/accounts/activity_evidence.html | 9.3 | 1 | referenced by automated test |
| /accounts/advances | Advances Queue - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/ready_for_advance.html | 9.3 | 1 | referenced by automated test |
| /accounts/advances/ | Advances Queue - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/ready_for_advance.html | 9.3 | 1 | referenced by automated test |
| /accounts/approval-history | Approval History - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/approval_history.html | 9.3 | 1 | referenced by automated test |
| /accounts/approval-history/ | Approval History - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/approval_history.html | 9.3 | 1 | referenced by automated test |
| /accounts/audit-log | Finance Audit Log - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/audit_log.html | 9.3 | 1 | referenced by automated test |
| /accounts/audit-log/ | Finance Audit Log - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/audit_log.html | 9.3 | 1 | referenced by automated test |
| /accounts/batch-payments | Batch Payments - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/batch_payments.html | 9.5 | 1 | referenced by automated test |
| /accounts/batch-payments/ | Batch Payments - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/batch_payments.html | 9.5 | 1 | referenced by automated test |
| /accounts/blocked | Blocked Items - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/blocked.html | 9.3 | 1 | referenced by automated test |
| /accounts/blocked/ | Blocked Items - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/blocked.html | 9.3 | 1 | referenced by automated test |
| /accounts/cleared | Cleared Ledger - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/cleared.html | 9.3 | 1 | referenced by automated test |
| /accounts/cleared/ | Cleared Ledger - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/cleared.html | 9.3 | 1 | referenced by automated test |
| /accounts/monthly-request | Monthly Fund Request - Edify Command Center | ACCOUNTANT, ADMIN, CD, IA, PL, PROJECT_COORDINATOR, RVP | pages/accounts/monthly_request.html | 9.3 | 1 | coverage review required |
| /accounts/monthly-request/ | Monthly Fund Request - Edify Command Center | ACCOUNTANT, ADMIN, CD, IA, PL, PROJECT_COORDINATOR, RVP | pages/accounts/monthly_request.html | 9.3 | 1 | coverage review required |
| /accounts/partner-payments | Partner Payments - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/partner_payments.html | 9.3 | 1 | referenced by automated test |
| /accounts/partner-payments/ | Partner Payments - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/partner_payments.html | 9.3 | 1 | referenced by automated test |
...
| /accounts/reimbursements | Reimbursements Queue - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/reimbursements.html | 9.3 | 1 | referenced by automated test |
| /accounts/reimbursements/ | Reimbursements Queue - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/reimbursements.html | 9.3 | 1 | referenced by automated test |
...
| /accounts/returned | Returned Items - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/returned.html | 9.3 | 1 | referenced by automated test |
| /accounts/returned/ | Returned Items - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/returned.html | 9.3 | 1 | referenced by automated test |
| /accounts/variance-review | Variance Review - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/variance_review.html | 9.5 | 1 | referenced by automated test |
| /accounts/variance-review/ | Variance Review - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/variance_review.html | 9.5 | 1 | referenced by automated test |
| /accounts/weekly-requests | Weekly Fund Requests - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/weekly_requests.html | 9.3 | 1 | referenced by automated test |
| /accounts/weekly-requests/ | Weekly Fund Requests - Edify Command Center | ACCOUNTANT, ADMIN | pages/accounts/weekly_requests.html | 9.3 | 1 | referenced by automated test |
| /activities/<str:activity_id> | Activity Details | ADMIN, CCEO, PARTNER, PL, PROJECT_COORDINATOR | partials/my_plan/activity_detail_drawer.html<br>pages/my_plan/detail.html | 9.5 | 1 | referenced by automated test |
...
| /activities/<str:activity_id>/closure | Closure Workspace - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/activity_closure_detail.html | 9.6 | 1 | referenced by automated test |
| /activities/<str:activity_id>/closure/ | Closure Workspace - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/activity_closure_detail.html | 9.6 | 1 | referenced by automated test |
...
| /activities/<str:activity_id>/timeline | Activity Journey Timeline - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/activity_timeline.html | 9.5 | 1 | referenced by automated test |
| /activities/<str:activity_id>/timeline/ | Activity Timeline - Edify Command Center | ADMIN | pages/ia/activity_timeline.html | 9.5 | 1 | coverage review required |
| /activities/closure | Activity Closure Center - Edify | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/readiness_queue.html | 9.5 | 1 | referenced by automated test |
| /activities/closure/ | Activity Closure Center - Edify | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/readiness_queue.html | 9.5 | 1 | referenced by automated test |
| /activities/closure/blocked | Blocked Closures - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/blocked_closure.html | 9.3 | 1 | referenced by automated test |
| /activities/closure/blocked/ | Blocked Closures - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/blocked_closure.html | 9.3 | 1 | referenced by automated test |
...
| /change-password | Change Password | Unmapped | pages/auth/change_password.html | 9.5 | 1 | referenced by automated test |
| /clusters | Clusters | ADMIN, CCEO, CD, IA, PARTNER, PL | partials/clusters/htmx_response.html<br>pages/clusters/index.html | 9.5 | 1 | referenced by automated test |
| /clusters/<str:cluster_id> | Cluster details | ADMIN, CCEO, CD, IA, PARTNER, PL | pages/clusters/detail.html | 9.3 | 1 | referenced by automated test |
| /clusters/<str:cluster_id>/bulk-assign-drawer | Cluster Bulk Assign Drawer | ADMIN, CCEO, PL, PROJECT_COORDINATOR | partials/schools/toast_success.html<br>partials/clusters/bulk_assign_drawer.html | 9.5 | 1 | referenced by automated test |
...
| /clusters/<str:cluster_id>/edit-drawer | Edit Cluster Drawer | ADMIN, CCEO, PL, PROJECT_COORDINATOR | partials/clusters/edit_cluster_drawer.html | 9.3 | 1 | referenced by automated test |
...
| /clusters/create-drawer | Create Cluster Drawer | ADMIN, CCEO, PL, PROJECT_COORDINATOR | partials/clusters/create_cluster_drawer.html | 9.3 | 1 | referenced by automated test |
...
| /completed-activities | Completed Archive - Edify Command Center | ADMIN, CCEO, IA, PL, PROJECT_COORDINATOR | pages/closure/completed_activities.html | 9.3 | 1 | coverage review required |
| /completed-activities/<str:activity_id> | Completed Activity Record - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/completed_detail.html | 9.3 | 1 | referenced by automated test |
| /completed-activities/<str:activity_id>/ | Completed Activity Record - Edify Command Center | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/closure/completed_detail.html | 9.3 | 1 | referenced by automated test |
| /compliance-register | · Edify HCOS | ADMIN, HR | pages/hr/placeholder.html | 9.3 | 1 | coverage review required |
| /core-schools | Core Schools | ADMIN, CCEO, IA, PL | partials/core_schools/matrix_table.html<br>pages/core_schools/index.html | 9.3 | 1 | referenced by automated test |
| /core-schools/<str:plan_id> | Core School Plan | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/core_schools/detail.html | 9.3 | 1 | referenced by automated test |
...
| /core-schools/<str:school_id>/champion-review | Champion Review Drawer | ADMIN, CCEO, IA, PL | partials/core_schools/champion_review_drawer.html | 9.5 | 1 | referenced by automated test |
| /core-schools/assessment | Core Assessment Drawer | ADMIN, CCEO, IA, PL | partials/core_schools/core_assessment_drawer.html | 9.5 | 1 | referenced by automated test |
...
| /debriefs | Field Debrief | ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | partials/debriefs/dashboard_table.html<br>partials/debriefs/dashboard_body.html<br>pages/debriefs/dashboard.html | 9.8 | 1 | referenced by automated test |
| /debriefs/<str:debrief_id> | · Field Debrief · Edify | ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | pages/debriefs/detail.html | 9.6 | 1 | coverage review required |
...
| /debriefs/submit | New Field Debrief · Edify | ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | pages/debriefs/submit.html | 9.6 | 1 | referenced by automated test |
| /disbursements | Fund Disbursement Dashboard | ACCOUNTANT, ADMIN | partials/disbursements/root.html<br>pages/disbursements/index.html | 9.6 | 1 | referenced by automated test |
| /disbursements/action | Fund Disbursement Dashboard | ACCOUNTANT, ADMIN | partials/disbursements/root.html | 9.6 | 1 | referenced by automated test |
...
| /districts | Districts | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/districts/index.html | 9.3 | 1 | referenced by automated test |
| /districts/<str:district_id> | District | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/districts/detail.html | 9.3 | 1 | referenced by automated test |
| /employee-relations | · Edify HCOS | ADMIN, HR | pages/hr/placeholder.html | 9.3 | 1 | coverage review required |
| /evidence | Evidence Gallery | ADMIN, CCEO, PL, PROJECT_COORDINATOR | Dynamic / none detected | 9.4 | 0 | referenced by automated test |
| /evidence/ | Evidence Center | ADMIN, CCEO, CD, PARTNER, PL, PROJECT_COORDINATOR | pages/evidence/index.html | 9.3 | 1 | referenced by automated test |
...
| /fund-requests/weekly/<str:request_id> | Weekly Request details - Edify Command Center | ACCOUNTANT, ADMIN, CCEO, CD, IA, PL | pages/fund_requests/detail.html | 9.3 | 1 | referenced by automated test |
...
| /ia/history/ | Verification History - Edify Command Center | ADMIN, IA | pages/ia/verification_history.html | 9.3 | 1 | referenced by automated test |
...
| /leave/approvals | Leave Approvals Cockpit | ADMIN, CD, HR, PL, RVP | pages/leave/leave_approvals.html | 9.6 | 1 | referenced by automated test |
| /leave/approvals/ | Leave Approvals Cockpit | ADMIN, CD, HR, PL, RVP | pages/leave/leave_approvals.html | 9.6 | 1 | referenced by automated test |
...
| /leave/approvals/<str:leave_id>/impact | Leave Impact Partial | ADMIN, CD, HR, PL, RVP | partials/leave/impact_panel.html | 9.6 | 1 | coverage review required |
| /leave/approvals/<str:leave_id>/impact/ | Leave Impact Partial | ADMIN, CD, HR, PL, RVP | partials/leave/impact_panel.html | 9.6 | 1 | coverage review required |
...
| /leave/calendar | Team Leave Calendar | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | pages/leave/leave_calendar.html | 9.5 | 1 | coverage review required |
| /leave/calendar/ | Team Leave Calendar | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | pages/leave/leave_calendar.html | 9.5 | 1 | coverage review required |
| /leave/coverage | Delegated Coverage Access | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PL, RVP | pages/leave/leave_coverage.html | 9.6 | 1 | referenced by automated test |
| /leave/coverage/ | Delegated Coverage Access | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PL, RVP | pages/leave/leave_coverage.html | 9.6 | 1 | referenced by automated test |
...
| /map | School Map · Edify | ADMIN, CCEO, CD, IA, PL, PROJECT_COORDINATOR | pages/map/index.html | 9.3 | 1 | referenced by automated test |
...
| /messages/thread/<str:thread_id> | Message Thread | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | partials/messages/conversation.html | 9.5 | 1 | referenced by automated test |
...
| /messages/thread/<str:thread_id>/reply | Message Thread Reply | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | partials/messages/conversation.html | 9.5 | 1 | referenced by automated test |
...
| /my-professional-development/request | Pd Request | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PL, PROJECT_COORDINATOR, RVP | partials/professional_development/request_form.html | 9.6 | 1 | referenced by automated test |
...
| /offboarding | · Edify HCOS | ADMIN, HR | pages/hr/placeholder.html | 9.3 | 1 | coverage review required |
| /onboarding | · Edify HCOS | ADMIN, HR | pages/hr/placeholder.html | 9.3 | 1 | referenced by automated test |
...
| /performance-reviews | · Edify HCOS | ADMIN, CD, HR, PL | pages/hr/placeholder.html | 9.3 | 1 | referenced by automated test |
| /personal-time-off | Personal Time Off · Edify | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | pages/leave/personal_time_off.html | 9.6 | 1 | referenced by automated test |
| /personal-time-off/ | Personal Time Off · Edify | ACCOUNTANT, ADMIN, CCEO, CD, HR, IA, PARTNER, PL, PROJECT_COORDINATOR, RVP | pages/leave/personal_time_off.html | 9.6 | 1 | referenced by automated test |
...
| /schools/partial-intelligence/<str:school_id> | School Intelligence Partial | ADMIN, CCEO, CD, IA, PL, PROJECT_COORDINATOR | partials/schools/directory_intelligence.html | 9.5 | 1 | referenced by automated test |
| /schools/upload | Upload Data - Edify Command Center | ADMIN, IA | partials/upload_result.html<br>pages/schools/upload.html | 9.6 | 1 | referenced by automated test |
| /schools/upload/<str:batch_id>/preview | School Upload Preview | ADMIN, IA | pages/schools/upload_preview.html | 9.6 | 1 | referenced by automated test |
...
| /ssa/verification/ | IA SSA Verification Queue | ADMIN, CCEO, CD, IA, PL, RVP | pages/ssa/verification_queue.html | 9.6 | 1 | referenced by automated test |
| /staff | Human Resource Dashboard - Edify Command Center | ADMIN, CD, HR, PL, RVP | pages/staff/index.html | 9.3 | 1 | referenced by automated test |
| /staff/<str:user_id> | Staff Profile | ADMIN, CD, HR, PL, RVP | pages/staff/detail.html | 9.3 | 1 | referenced by automated test |
| /succession-planning | · Edify HCOS | ADMIN, HR | pages/hr/placeholder.html | 9.3 | 1 | coverage review required |
| /system-health | System Health & Integrity - Edify | ADMIN | pages/system_health/index.html | 9.6 | 1 | referenced by automated test |
...
| /visits | Visits Log | ADMIN, CCEO, PARTNER, PL, PROJECT_COORDINATOR | pages/visits/index.html | 9.3 | 1 | referenced by automated test |
| /wellness | · Edify HCOS | ADMIN, HR | pages/hr/placeholder.html | 9.3 | 1 | coverage review required |
| /work-plan | Work Plan | ADMIN, CCEO, PL, PROJECT_COORDINATOR | pages/work_plan/index.html | 9.5 | 1 | referenced by automated test |
| /workforce-planning | · Edify HCOS | ADMIN, CD, HR, RVP | pages/hr/placeholder.html | 9.3 | 1 | coverage review required |
