...
- Routed product surfaces: **363**
- All registered routes: **939**
- API routes: **528**
- Roles: **11**
- Permission keys: **39**
- Scheduled jobs: **7**
- Activity states: **23**
- Shared component templates: **212**
- Full pages: **234**
- Partials and drawers: **122**
- Permission-gated surfaces: **361**
- Referenced by automated tests: **323**
- Findings: critical **0**, high **0**, medium **0**, low **19**
...
| /admin-panel/users/<str:user_id> | Manage User: | ADMIN, CD, HR | pages/admin/user_detail.html | 9.6 | 0 | referenced by automated test |
...
| /evidence/ | Evidence Center | ADMIN, CCEO, CD, PARTNER, PL, PROJECT_COORDINATOR | pages/evidence/index.html | 9.4 | 0 | referenced by automated test |
...
| /ia/verification/<str:activity_id>/ | IA Review Workspace - Edify | ADMIN | pages/ia/review_workspace.html | 9.4 | 0 | coverage review required |
...
| /projects/analytics | Special Project Analytics | ADMIN, CCEO, CD, PL, PROJECT_COORDINATOR | pages/projects/analytics.html | 9.6 | 0 | referenced by automated test |
...
| /ssa | SSA Scores | ADMIN, CCEO, CD, IA, PL, RVP | pages/ssa/index.html | 9.4 | 0 | referenced by automated test |
