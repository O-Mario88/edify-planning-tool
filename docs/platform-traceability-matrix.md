...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `journey-01` | Priority to verified performance | ✓ | 2 | 87 | 37 | 3 | 3 | 5 | 18 | 46 |
| `journey-02` | SSA to school improvement | ✓ | 1 | 33 | 10 | 1 | 10 | 0 | 0 | 14 |
| `journey-03` | Standard staff school visit | ✓ | 13 | 81 | 39 | 4 | 8 | 9 | 26 | 46 |
| `journey-04` | Cluster training | ✓ | 1 | 39 | 15 | 0 | 0 | 0 | 1 | 41 |
| `journey-05` | Partner assignment and payment | ✓ | 1 | 40 | 27 | 2 | 2 | 1 | 4 | 54 |
| `journey-06` | Special Project | ✓ | 1 | 82 | 35 | 4 | 5 | 5 | 16 | 46 |
| `journey-07` | Fund overspending and reimbursement | ✓ | 5 | 60 | 32 | 5 | 10 | 8 | 22 | 46 |
| `journey-08` | Activity canceled after disbursement | ✓ | 2 | 57 | 25 | 3 | 6 | 7 | 18 | 45 |
| `journey-09` | Leave and temporary coverage | ✓ | 1 | 43 | 15 | 0 | 0 | 1 | 4 | 10 |
| `journey-10` | Quarterly Performance Conversation | ✓ | 1 | 77 | 39 | 3 | 3 | 5 | 23 | 46 |
| `journey-11` | Professional Development | ✓ | 1 | 34 | 8 | 0 | 0 | 1 | 1 | 0 |
| `journey-12` | Policy lifecycle | ✓ | 1 | 32 | 12 | 0 | 0 | 1 | 10 | 4 |
| `journey-13` | PIP | ✓ | 1 | 29 | 7 | 0 | 0 | 0 | 3 | 0 |
| `journey-14` | Team Oversight and Send School to | ✓ | 1 | 44 | 14 | 0 | 0 | 2 | 3 | 10 |
| `journey-15` | Financial Health | ✓ | 1 | 46 | 17 | 2 | 4 | 1 | 6 | 14 |
| `journey-16` | Government Requirements | ✓ | 1 | 45 | 17 | 2 | 4 | 1 | 5 | 14 |
| `journey-17` | Loan | ✓ | 1 | 38 | 25 | 11 | 7 | 3 | 17 | 22 |
| `journey-18` | Repeat borrower and student reach | ✓ | 1 | 39 | 21 | 9 | 6 | 1 | 9 | 18 |
...
| `journey-22` | Financial-year rollover | ✓ | 1 | 42 | 17 | 0 | 0 | 1 | 3 | 49 |
...
| Object-level guards | — |
| Services executed | `apps/accounts/auth_backend.py`, `apps/accounts/lockout_service.py`, `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py` _+77 more_ |
...
| Page gates checked | `disbursements`, `fund_requests`, `ia_review_workspace`, `monthly_request`, `my_plan`, `planning`, `reports`, `weekly_fund_request_disburse` |
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/closure_services.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py` _+71 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/signals.py`, `apps/clusters/eligibility.py` _+29 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/closure_services.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/signals.py` _+30 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/analytics/platform_engine.py` _+72 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/jwt.py`, `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py` _+50 more_ |
...
| Page gates checked | `my_plan` |
| Object-level guards | — |
| Services executed | `apps/accounts/jwt.py`, `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/models.py`, `apps/activities/services.py`, `apps/activities/views.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py` _+47 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/clusters/eligibility.py`, `apps/core/audit_hash.py`, `apps/core/calendar_policy.py`, `apps/core/context_processors.py`, `apps/core/cuid.py` _+33 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py` _+67 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/core/audit_hash.py`, `apps/core/context_processors.py`, `apps/core/cuid.py`, `apps/core/fy.py`, `apps/core/metrics/payload.py` _+24 more_ |
...
| Page gates checked | — |
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/core/audit_hash.py`, `apps/core/context_processors.py`, `apps/core/cuid.py`, `apps/core/logging_filters.py`, `apps/core/middleware.py` _+22 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/core/audit_hash.py`, `apps/core/context_processors.py`, `apps/core/cuid.py`, `apps/core/metrics/payload.py`, `apps/core/metrics/reconciled_registry.py` _+19 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activity_catalogue/scheduling_health.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/clusters/eligibility.py`, `apps/clusters/oversight_service.py`, `apps/core/audit_hash.py` _+34 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/frontend_views.py`, `apps/business_transformation/lending_impact.py`, `apps/business_transformation/lending_ledger.py`, `apps/business_transformation/models.py`, `apps/business_transformation/services.py` _+28 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/frontend_views.py`, `apps/business_transformation/lending_impact.py`, `apps/business_transformation/lending_ledger.py`, `apps/business_transformation/models.py`, `apps/business_transformation/services.py` _+29 more_ |
...
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/accounts/staff_matching.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/signals.py`, `apps/clusters/eligibility.py` _+25 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/presence.py`, `apps/activities/models.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/budget/costing_service.py`, `apps/budget/signals.py`, `apps/business_transformation/signals.py`, `apps/clusters/eligibility.py` _+32 more_ |
