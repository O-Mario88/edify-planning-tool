...
| `journey-06` | Special Project | ✓ | 1 | 81 | 35 | 4 | 5 | 5 | 16 | 46 |
| `journey-07` | Fund overspending and reimbursement | ✓ | 5 | 59 | 32 | 5 | 10 | 8 | 22 | 46 |
| `journey-08` | Activity canceled after disbursement | ✓ | 2 | 56 | 25 | 3 | 6 | 7 | 18 | 45 |
| `journey-09` | Leave and temporary coverage | ✓ | 1 | 42 | 15 | 0 | 0 | 1 | 4 | 10 |
| `journey-10` | Quarterly Performance Conversation | ✓ | 1 | 76 | 39 | 3 | 3 | 5 | 23 | 46 |
| `journey-11` | Professional Development | ✓ | 1 | 33 | 8 | 0 | 0 | 1 | 1 | 0 |
| `journey-12` | Policy lifecycle | ✓ | 1 | 31 | 12 | 0 | 0 | 1 | 10 | 4 |
| `journey-13` | PIP | ✓ | 1 | 28 | 7 | 0 | 0 | 0 | 3 | 0 |
| `journey-14` | Team Oversight and Send School to | ✓ | 1 | 42 | 14 | 0 | 0 | 2 | 3 | 10 |
| `journey-15` | Financial Health | ✓ | 1 | 45 | 17 | 2 | 4 | 1 | 6 | 14 |
| `journey-16` | Government Requirements | ✓ | 1 | 44 | 17 | 2 | 4 | 1 | 5 | 14 |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/closure_services.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py` _+70 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/signals.py`, `apps/clusters/eligibility.py`, `apps/clusters/services.py` _+28 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/closure_services.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/signals.py`, `apps/clusters/eligibility.py` _+29 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/analytics/platform_engine.py`, `apps/audit/services.py` _+71 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/jwt.py`, `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py` _+49 more_ |
...
| Page gates checked | `my_plan` |
| Object-level guards | — |
| Services executed | `apps/accounts/jwt.py`, `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/models.py`, `apps/activities/services.py`, `apps/activities/views.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/budget/costing.py` _+46 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/clusters/eligibility.py`, `apps/core/audit_hash.py`, `apps/core/calendar_policy.py`, `apps/core/context_processors.py`, `apps/core/cuid.py`, `apps/core/fy.py` _+32 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/activities/salesforce.py`, `apps/activities/services.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/budget/costing.py` _+66 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/core/audit_hash.py`, `apps/core/context_processors.py`, `apps/core/cuid.py`, `apps/core/fy.py`, `apps/core/metrics/payload.py`, `apps/core/metrics/reconciled_registry.py` _+23 more_ |
...
| Page gates checked | — |
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/core/audit_hash.py`, `apps/core/context_processors.py`, `apps/core/cuid.py`, `apps/core/logging_filters.py`, `apps/core/middleware.py`, `apps/core/models.py` _+21 more_ |
...
| Object-level guards | — |
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/activity_catalogue/scheduling_health.py`, `apps/activity_catalogue/services.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/clusters/eligibility.py`, `apps/clusters/oversight_service.py`, `apps/core/audit_hash.py`, `apps/core/context_processors.py` _+32 more_ |
...
| Services executed | `apps/accounts/middleware.py`, `apps/accounts/models.py`, `apps/accounts/staff_matching.py`, `apps/activities/ia_services.py`, `apps/activities/models.py`, `apps/admin_ops/detection.py`, `apps/audit/services.py`, `apps/business_transformation/signals.py`, `apps/clusters/eligibility.py`, `apps/core/audit_hash.py` _+24 more_ |
