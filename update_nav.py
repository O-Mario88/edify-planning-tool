nav_items = [
    ...
    (
        ...
        "request.user.active_role in 'CCEO,CountryProgramLead,CountryDirector,ProjectCoordinator'",
    ),
    (
        "My Plan",
        "/my-plan",
        "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
        "request.user.active_role in 'CCEO,CountryProgramLead,PartnerFieldOfficer'",
    ),
    (
        "Daily Debrief",
        "/debriefs",
    ...
    (
        ...
        "/partners",
        "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
        "request.user.active_role in 'CountryDirector,CountryProgramLead,Admin,PartnerFieldOfficer'",
    ),
    # --- ACTIVITY ---
    ("ACTIVITY", None, None),
    (
        ...
        "request.user.active_role in 'CCEO,ImpactAssessment,CountryProgramLead'",
    ),
    (
        "Fund Requests",
        "/fund-requests/weekly",
        "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
        "request.user.active_role in 'ProgramAccountant,CCEO,CountryProgramLead,CountryDirector'",
    ),
    (
        "My Budget",
        "/budgets/monthly",
        "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z",
        "request.user.active_role in 'ProgramAccountant,CountryProgramLead,CountryDirector'",
    ),
    (
        "Completed Activities",
        "/trainings",
        "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01",
        "request.user.active_role in 'CCEO,CountryProgramLead,CountryDirector'",
    ),
    # --- INSIGHTS ---
    ("INSIGHTS", None, None),
    ...
    (
        ...
        "request.user.active_role == 'CountryProgramLead'",
    ),
    (
        "Core Schools",
        "/core-schools",
    ...
    (
        ...
        "request.user.active_role in 'Admin,CountryDirector'",
    ),
]
...
with open(
    "/Users/omario/Developer/Edify Planning Tool/edify-api/templates/layouts/navigation_items.html",
    "w",
) as f:
    f.write("\n\n".join(output))
