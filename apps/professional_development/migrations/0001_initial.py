    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["staff_id", "fy"], name="pd_allocati_staff_i_5ac70f_idx"
                    )
                ],
                "constraints": [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="professional_development.professionaldevelopmentfundrequest",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("fully_funded", "Fully Funded by Edify"),
                            ("partially_funded", "Partially Funded by Edify"),
                            ("self_funded", "Self-Funded"),
                            ("free", "Free Course"),
                            ("scholarship", "External Scholarship"),
                        ],
                        default="self_funded",
                        max_length=20,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("pending_exception", "Pending Exception Approval"),
                            ("rejected", "Rejected"),
                            ("cancelled", "Cancelled"),
                            ("approved_pending_funding", "Approved — Pending Finance"),
                            ("approved_unfunded", "Approved"),
                            ("disbursed", "Funds Disbursed"),
                            ("enrollment_pending", "Enrollment Pending"),
                            ("enrollment_confirmed", "Enrollment Confirmed"),
                            ("in_progress", "Course In Progress"),
                            ("ended", "Course Ended"),
                            ("marked_complete", "Employee Marked Complete"),
                            ("certificate_uploaded", "Certificate Uploaded"),
                            ("bamboohr_confirmed", "BambooHR Upload Confirmed"),
                            ("accountability_submitted", "Accountability Submitted"),
                            ("accountability_cleared", "Accountability Cleared"),
                            ("awaiting_hr_signoff", "Awaiting HR Sign-Off"),
                            ("completed_closed", "Completed and Closed"),
                            ("deferred", "Deferred"),
                            ("withdrawn", "Withdrawn"),
                        ],
                        default="draft",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["staff_id", "fy"], name="pd_request_staff_i_70715b_idx"
                    ),
                    models.Index(
                        fields=["status"], name="pd_request_status_553cdd_idx"
                    ),
                    models.Index(
                        fields=["start_date", "end_date"],
                        name="pd_request_start_d_ffebb9_idx",
                    ),
                ],
            },
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                to="professional_development.professionaldevelopmentrequest",
            ),
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("invoice", "Institution Invoice"),
                            ("fee_structure", "Fee Structure"),
                            ("acceptance_email", "Acceptance Email (PDF)"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["request"], name="pd_evidence_request_ef64c2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="professionaldevelopmentcertificate",
            index=models.Index(
                fields=["request"], name="pd_certific_request_c86981_idx"
            ),
        ),
    ]
