...
class PerformanceInsightsServiceTests(TestCase):
    ...
    def test_regions_are_scoped_and_verified_only_with_top_region(self):
        ...
        d2 = District.objects.create(name="Gulu", region=other, district_type="primary")
        s2 = School.objects.create(
            school_id="PI-3",
            name="Client Elsewhere",
            school_type="client",
            region=other,
            district=d2,
            enrollment=10,
    ...
    def test_template_composes_the_approved_grid(self):
        src = (
            ROOT / "templates/partials/core_schools/performance_insights.html"
        ).read_text()
