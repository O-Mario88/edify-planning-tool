    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "baseline_ssa_record_id",
                    models.CharField(blank=True, max_length=30, null=True),
                ),
                (
                    "follow_up_ssa_record_id",
                    models.CharField(blank=True, max_length=30, null=True),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "champion_status",
                    models.CharField(default="Not Eligible", max_length=32),
                ),
                ("status", models.CharField(default="Active", max_length=32)),
                (
                    "core_plan",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["core_plan"], name="core_activi_core_pl_e3f0db_idx"
                    ),
                    models.Index(
                        fields=["school_id"], name="core_activi_school__1014ee_idx"
                    ),
                ],
            },
        ),
