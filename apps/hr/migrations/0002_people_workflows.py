    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ("informal", "Informal recovery plan"),
                    ("formal", "Formal performance improvement plan"),
                ],
                default="informal",
                max_length=16,
            ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("priorities_draft", "Employee drafting priorities"),
                    ("priorities_manager_review", "Manager reviewing priorities"),
                    ("priorities_agreed", "Priorities agreed"),
                    ("employee_reflection", "Employee reflection"),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("supervisor_review", "Awaiting supervisor confirmation"),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ("capacity", "Capacity — portfolio beyond capacity"),
                    ("workload", "Workload — competing demands"),
                    ("skill", "Skill gap"),
                    ("availability", "Availability — leave or absence"),
                    ("data_quality", "Data quality — work done but not credited"),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("extended", "Extended"),
                    ("escalated", "Escalated to a conduct case"),
                    ("closed", "Closed"),
                ],
                default="draft",
                max_length=32,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ("annual_priorities", "Annual priorities"),
                    ("mid_year", "Mid-year review"),
                    ("year_end", "Year-end review"),
                    ("quarterly", "Quarterly review"),
                    ("probation", "Probation review"),
                ],
                default="annual_priorities",
                max_length=64,
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AddIndex(
            model_name="employeerelationscase",
            index=models.Index(
                fields=["country", "status"], name="hr_relation_country_92d152_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="performancereview",
            index=models.Index(
                fields=["staff", "fy"], name="hr_performa_staff_i_472064_idx"
            ),
        ),
        migrations.AddField(
