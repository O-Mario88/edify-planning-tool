...
class BiBoardsView(APIView):
    ...
    def get(self, request):
        return Response(services.boards(request.user, _q(request)))
...
class BiSnapshotView(APIView):
    ...
    def get(self, request):
        return Response(services.snapshot(request.user, _q(request)))
...
class BiInsightView(APIView):
    ...
    def get(self, request, insight_id):
        return Response(services.get_insight(insight_id))
...
class BiInsightMemoView(APIView):
    ...
    def get(self, request, insight_id):
        return Response(services.memo(insight_id))
...
class BiInsightReviewView(APIView):
    ...
    def post(self, request, insight_id):
        return Response(services.review(insight_id, request.data, request.user))
...
class BiInsightNoteView(APIView):
    ...
    def post(self, request, insight_id):
        return Response(
            services.add_note(insight_id, request.data, request.user), status=201
        )
...
class BiRecomputeView(APIView):
    ...
    def post(self, request):
        return Response(services.recompute(request.data or _q(request), request.user))
