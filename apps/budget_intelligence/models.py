...
class BudgetIntelligenceInsight(TimeStampedModel):
    ...
    insight_type = models.CharField(max_length=32)  # monthly|partner|activity|regional|...
...
class FinanceDecisionNote(TimeStampedModel):
    id = CuidField()
    insight = models.ForeignKey(BudgetIntelligenceInsight, on_delete=models.CASCADE, related_name="notes")
