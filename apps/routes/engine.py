...
class RouteValidationService:
    ...
    def validate(schools, *, visit_date=None, responsible_user=None) -> list[dict]:
        ...
        # REG-02 (restored by owner decision, 2026-09-22) — a route can never
        # be scored feasible for a date Planning/My Plan would block (Sunday,
        # public holiday, blackout, or the responsible staff member's approved
        # leave). Only the calendar half of 23e3bfba comes back; the frequency
        # caps and annual entitlements stay removed.
