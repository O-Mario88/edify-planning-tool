...
urlpatterns = [
    ...
    path("schools/bulk-assign-project", school_views.bulk_assign_project_view, name="bulk_assign_project"),
    ...
    path("schools/<str:school_id>/change-type", school_views.school_change_type_view, name="school_change_type"),
    path("schools/<str:school_id>/add-to-cluster", school_views.add_to_cluster_drawer_view, name="add_to_cluster_drawer"),
    path("schools/<str:school_id>/edit-drawer", school_views.school_edit_drawer_view, name="school_edit_drawer"),
    path("schools/create-drawer", school_views.school_onboard_drawer_view, name="school_onboard_drawer"),
    path("schools/<str:school_id>/assign-to-project", school_views.assign_to_project_drawer_view, name="assign_to_project_drawer"),
    ...
    path("clusters/planner-drawer", cluster_views.planner_drawer_view, name="cluster_planner_drawer"),
    path("clusters/schedule-training-drawer", cluster_views.schedule_training_drawer_view, name="schedule_training_drawer"),
    path("clusters/schedule-meeting-drawer", cluster_views.schedule_meeting_drawer_view, name="schedule_meeting_drawer"),
    path("clusters/detail-drawer/<str:cluster_id>", cluster_views.cluster_detail_drawer_view, name="cluster_detail_drawer"),
    path("clusters/impact-drawer/<str:cluster_id>", cluster_views.intervention_impact_drawer_view, name="cluster_impact_drawer"),
    ...
    path("clusters/<str:cluster_id>/bulk-assign-drawer", cluster_views.cluster_bulk_assign_drawer_view, name="cluster_bulk_assign_drawer"),
    ...
    path("my-plan/<str:activity_id>/complete-drawer", my_plan_views.complete_drawer_view, name="complete_drawer"),
    path("my-plan/<str:activity_id>/reschedule-drawer", my_plan_views.reschedule_drawer_view, name="reschedule_drawer"),
    ...
    path("activities/<str:activity_id>", my_plan_views.activity_detail_view, name="activity_detail_full"),
    path("activities/<str:activity_id>/start", my_plan_views.start_activity_drawer_view, name="start_activity_drawer"),
    path("activities/<str:activity_id>/start/action", my_plan_views.start_activity_action, name="start_activity_action"),
    path("activities/<str:activity_id>/complete", my_plan_views.complete_activity_drawer_view, name="complete_activity_drawer"),
    path("activities/<str:activity_id>/complete/action", my_plan_views.complete_activity_action, name="complete_activity_action"),
    path("activities/<str:activity_id>/evidence", my_plan_views.evidence_upload_drawer_view, name="evidence_upload_drawer"),
    path("activities/<str:activity_id>/evidence/action", my_plan_views.evidence_upload_action, name="evidence_upload_action"),
    path("activities/<str:activity_id>/evidence/detail", my_plan_views.evidence_packet_view, name="evidence_packet"),
    path("activities/<str:activity_id>/salesforce-id", my_plan_views.salesforce_id_drawer_view, name="salesforce_id_drawer"),
    path("activities/<str:activity_id>/salesforce-id/action", my_plan_views.salesforce_id_action, name="salesforce_id_action"),
    path("activities/<str:activity_id>/submit", my_plan_views.submit_for_review_drawer_view, name="submit_for_review_drawer"),
    path("activities/<str:activity_id>/submit/action", my_plan_views.submit_for_review_action, name="submit_for_review_action"),
    path("activities/<str:activity_id>/timeline", my_plan_views.activity_timeline_drawer_view, name="activity_timeline_drawer"),
    path("activities/<str:activity_id>/attendance", my_plan_views.attendance_upload_drawer_view, name="attendance_upload_drawer"),
    path("activities/<str:activity_id>/attendance/action", my_plan_views.attendance_upload_action, name="attendance_upload_action"),
    path("activities/<str:activity_id>/ssa-upload", my_plan_views.ssa_evidence_upload_drawer_view, name="ssa_evidence_upload_drawer"),
    path("activities/<str:activity_id>/ssa-upload/action", my_plan_views.ssa_evidence_upload_action, name="ssa_evidence_upload_action"),
    path("evidence/", my_plan_views.evidence_center_view, name="evidence_center"),
    path("evidence/returned", my_plan_views.returned_evidence_view, name="returned_evidence"),
    path("accounts/activity-evidence/<str:activity_id>", my_plan_views.accounts_activity_evidence_view, name="accounts_activity_evidence"),
    ...
    path("ia/verification/", ia_views.ia_verification_queue_view, name="ia_verification_queue"),
    path("ia/verification/<str:activity_id>/", ia_views.ia_review_workspace_view, name="ia_review_workspace"),
    path("ia/verification/<str:activity_id>/verify", ia_views.ia_verify_action, name="ia_verify_action"),
    path("ia/verification/<str:activity_id>/return", ia_views.ia_return_action, name="ia_return_action"),
    ...
    path("ia/duplicates/<str:duplicate_id>/action", ia_views.ia_duplicate_action, name="ia_duplicate_action"),
    ...
    path("activities/<str:activity_id>/timeline/", ia_views.activity_timeline_view, name="activity_timeline"),
    ...
    path("analytics/drilldown", analytics_views.analytics_drilldown_view, name="analytics_drilldown"),
    path("analytics/schedule-report", analytics_views.analytics_schedule_report_view, name="analytics_schedule_report"),
    path("analytics/customize-dashboard", analytics_views.analytics_customize_dashboard_view, name="analytics_customize_dashboard"),
    ...
    # Notifications
    path("notifications", RedirectView.as_view(url="/dashboard", permanent=False), name="notifications"),
    path("notifications/drawer", staff_views.notification_drawer_view, name="notifications_drawer"),
    path("notifications/mark-all-read", staff_views.mark_all_notifications_read, name="mark_all_notifications_read"),
    ...
    path("finance/actions/drawer", finance_views.finance_action_drawer_view, name="finance_action_drawer"),
    path("finance/actions/disburse_advance", finance_views.disburse_advance_action, name="disburse_advance_action"),
    path("finance/actions/clear_partner_payment", finance_views.clear_partner_payment_action, name="clear_partner_payment_action"),
    path("finance/actions/process_reimbursement", finance_views.process_reimbursement_action, name="process_reimbursement_action"),
    path("finance/actions/confirm_accountability", finance_views.confirm_accountability_action, name="confirm_accountability_action"),
    path("finance/actions/return_correction", finance_views.finance_return_action, name="finance_return_action"),
    ...
    path("finance/fund-allocation/admin-budget-drilldown", finance_views.admin_budget_drilldown_view, name="admin_budget_drilldown"),
    path("finance/fund-allocation/drilldown", finance_views.allocation_drilldown_view, name="allocation_drilldown"),
    path("finance/fund-allocation/export-drawer", finance_views.export_drawer_view, name="export_drawer"),
    
    # ── Controlled Finance Operating System ───────────────────────────────────
    path("accounts", finance_operating_views.accountant_dashboard_view, name="finance_dashboard"),
    path("accounts/", finance_operating_views.accountant_dashboard_view),
    path("accounts/advances", finance_operating_views.ready_for_advance_view, name="finance_ready_for_advance"),
    path("accounts/advances/", finance_operating_views.ready_for_advance_view),
    path("accounts/activities/<str:activity_id>/disburse", finance_operating_views.mark_disbursed_action, name="finance_mark_disbursed"),
    path("accounts/partner-payments", finance_operating_views.partner_payments_view, name="finance_partner_payments"),
    path("accounts/partner-payments/", finance_operating_views.partner_payments_view),
    path("accounts/partner-payments/<str:activity_id>/pay", finance_operating_views.pay_partner_action, name="finance_pay_partner"),
    path("accounts/reimbursements", finance_operating_views.reimbursements_view, name="finance_reimbursements"),
    path("accounts/reimbursements/", finance_operating_views.reimbursements_view),
    path("accounts/reimbursements/<str:claim_id>/pay", finance_operating_views.pay_reimbursement_action, name="finance_pay_reimbursement"),
    path("accounts/accountability", finance_operating_views.accountability_view, name="finance_accountability"),
    path("accounts/accountability/", finance_operating_views.accountability_view),
    path("accounts/activities/<str:activity_id>/netsuite-id", finance_operating_views.netsuite_id_action, name="finance_netsuite_id"),
    path("accounts/blocked", finance_operating_views.blocked_view, name="finance_blocked"),
    path("accounts/blocked/", finance_operating_views.blocked_view),
    path("accounts/variance-review", finance_operating_views.variance_review_view, name="finance_variance_review"),
    path("accounts/variance-review/", finance_operating_views.variance_review_view),
    path("accounts/returned", finance_operating_views.returned_view, name="finance_returned"),
    path("accounts/returned/", finance_operating_views.returned_view),
    path("accounts/cleared", finance_operating_views.cleared_view, name="finance_cleared"),
    path("accounts/cleared/", finance_operating_views.cleared_view),
    path("accounts/activities/<str:activity_id>", finance_operating_views.activity_finance_detail_view, name="finance_activity_detail"),
    path("accounts/activities/<str:activity_id>/", finance_operating_views.activity_finance_detail_view),
    path("accounts/batch-payments", finance_operating_views.batch_payments_view, name="finance_batch_payments"),
    path("accounts/batch-payments/", finance_operating_views.batch_payments_view),
    path("accounts/approval-history", finance_operating_views.approval_history_view, name="finance_approval_history"),
    path("accounts/approval-history/", finance_operating_views.approval_history_view),
    path("accounts/audit-log", finance_operating_views.audit_log_view, name="finance_audit_log"),
    path("accounts/audit-log/", finance_operating_views.audit_log_view),
    path("accounts/monthly-request", finance_operating_views.monthly_request_view, name="finance_monthly_request"),
    path("accounts/monthly-request/", finance_operating_views.monthly_request_view),
    path("accounts/weekly-requests", finance_operating_views.weekly_requests_view, name="finance_weekly_requests"),
    path("accounts/weekly-requests/", finance_operating_views.weekly_requests_view),
    
    # ── Controlled Activity Closure Workflow ──────────────────────────────────
    path("activities/closure", closure_views.closure_readiness_queue_view, name="closure_readiness"),
    path("activities/closure/", closure_views.closure_readiness_queue_view),
    path("activities/<str:activity_id>/closure", closure_views.activity_closure_detail_view, name="activity_closure_detail"),
    path("activities/<str:activity_id>/closure/", closure_views.activity_closure_detail_view),
    path("activities/<str:activity_id>/closure/close", closure_views.close_activity_action, name="close_activity"),
    path("completed-activities/<str:activity_id>", closure_views.completed_activity_detail_view, name="completed_activity_detail"),
    path("completed-activities/<str:activity_id>/", closure_views.completed_activity_detail_view),
    path("activities/closure/blocked", closure_views.blocked_closure_view, name="blocked_closure"),
    path("activities/closure/blocked/", closure_views.blocked_closure_view),
    path("activities/<str:activity_id>/reopen", closure_views.reopen_activity_action, name="reopen_activity"),
    path("activities/<str:activity_id>/timeline", closure_views.activity_timeline_view, name="activity_timeline"),
    path("analytics/publishing", closure_views.analytics_publishing_status_view, name="analytics_publishing_status"),
    ...
    path("admin-panel/users/<str:user_id>", extended_views.admin_user_detail_view, name="admin_user_detail"),
    path("admin-panel/audit-log", extended_views.audit_log_view, name="audit_log"),
    path("admin-panel/roles-permissions", extended_views.admin_roles_permissions_view, name="admin_roles_permissions"),
    path("admin-panel/staff-setup-queue", extended_views.admin_staff_setup_queue_view, name="admin_staff_setup_queue"),
    path("admin-panel/school-upload-history", extended_views.admin_school_upload_history_view, name="admin_school_upload_history"),
    ...
    path("ssa/unmatched", extended_views.unmatched_ssa_queue_view, name="unmatched_ssa_queue"),
    path("admin-panel/workflow-rules", extended_views.admin_workflow_rules_view, name="admin_workflow_rules"),
    path("admin-panel/page-access-matrix", extended_views.admin_page_access_matrix_view, name="admin_page_access_matrix"),
    path("admin-panel/region-district-setup", extended_views.admin_region_district_setup_view, name="admin_region_district_setup"),
    path("admin-panel/notifications-mgmt", extended_views.admin_notifications_mgmt_view, name="admin_notifications_mgmt"),
    ...
    path("core-schools/schedule-visit", core_schools_views.core_schedule_visit_drawer, name="core_schedule_visit_drawer"),
    path("core-schools/schedule-visit/action", core_schools_views.core_schedule_visit_action, name="core_schedule_visit_action"),
    path("core-schools/schedule-training", core_schools_views.core_schedule_training_drawer, name="core_schedule_training_drawer"),
    path("core-schools/schedule-training/action", core_schools_views.core_schedule_training_action, name="core_schedule_training_action"),
    path("core-schools/assign-partner", core_schools_views.core_assign_partner_drawer, name="core_assign_partner_drawer"),
    path("core-schools/assign-partner/action", core_schools_views.core_assign_partner_action, name="core_assign_partner_action"),
    path("core-schools/assessment", core_schools_views.core_assessment_drawer, name="core_assessment_drawer"),
    path("core-schools/strategy-playbook", core_schools_views.core_strategy_playbook_drawer, name="core_strategy_playbook_drawer"),
    path("core-schools/<str:plan_id>", extended_views.core_school_detail_view, name="core_school_detail"),
    path("core-schools/champion-candidates", core_schools_views.champion_candidates_view, name="champion_candidates"),
    path("core-schools/<str:school_id>/champion-review", core_schools_views.champion_review_drawer, name="champion_review_drawer"),
    path("core-schools/<str:school_id>/champion-approve", core_schools_views.champion_approve_action, name="champion_approve_action"),
    path("core-schools/<str:school_id>/champion-reject", core_schools_views.champion_reject_action, name="champion_reject_action"),
    path("core-schools/champions", core_schools_views.champions_list_view, name="champions_list"),
    ...
    path("completed-activities", closure_views.completed_activities_view, name="completed_activities"),
    ...
    path("cost-settings/row/<str:key>", finance_views.cost_setting_row_view, name="cost_setting_row"),
    path("cost-settings/initialize-default", finance_views.initialize_default_catalogue_view, name="initialize_default_catalogue"),
