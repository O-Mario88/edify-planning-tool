...
from apps.fund_requests.models import WeeklyFundRequest, WeeklyFundRequestLine, AdvanceRequest, AdvanceRequestStatus
...
class AccountantAndAutomatedHandoffsTest(TestCase):
    def setUp(self):
        ...
        self.wfr = WeeklyFundRequest.objects.create(
            ...
            week_end_date=date.today() - timedelta(days=date.today().weekday()) + timedelta(days=6),
            responsible_user=self.cceo_user.user_id,
            total_amount=50000,
    ...
    def test_submit_accountability_and_confirm(self):
        ...
        submit_accountability(self.adv.id, {"amountSpent": 45000, "amountReturned": 5000, "netsuiteId": "EXP-9900"}, self.cceo_user)
        self.adv.refresh_from_db()
    ...
    def test_submit_reimbursement_and_disburse(self):
        ...
        # Submit claim
        submit_reimbursement(self.adv.id, {"amountSpent": 50000, "netsuiteId": "EXP-9901"}, self.cceo_user)
        self.adv.refresh_from_db()
        ...
        # Reimburse/Disburse
        process_reimburse(self.adv.id, {"method": "bank_transfer", "reference": "BANK-REF-99"}, self.accountant)
        self.adv.refresh_from_db()
