    ...
    operations = [
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "self_funded",
                                "Use Own Funds (claim reimbursement later)",
                            ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status"], name="advance_req_status_c044e0_idx"
                    ),
                    models.Index(
                        fields=["responsible_user_id"],
                        name="advance_req_respons_f97908_idx",
                    ),
                    models.Index(
                        fields=["fy", "month"], name="advance_req_fy_480aae_idx"
                    ),
                ],
                "constraints": [
