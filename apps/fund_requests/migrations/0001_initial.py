    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.CharField(choices=[('weekly', 'Weekly'), ('monthly', 'Monthly'), ('quarterly', 'Quarterly'), ('annual', 'Annual')], max_length=16)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status'], name='fund_reques_status_9abf3b_idx'), models.Index(fields=['fy', 'period'], name='fund_reques_fy_245341_idx'), models.Index(fields=['submitted_by_user_id'], name='fund_reques_submitt_b19958_idx')],
                'constraints': [models.UniqueConstraint(fields=('submitted_by_user_id', 'period', 'period_key'), name='uniq_request_period_owner')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fund_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='fund_requests.fundrequest')),
            ],
            options={
                'db_table': 'fund_request_item',
                'indexes': [models.Index(fields=['activity_id'], name='fund_reques_activit_c76a4a_idx')],
                'constraints': [models.UniqueConstraint(fields=('fund_request', 'activity_schedule_cost_line_id'), name='uniq_request_costline'), models.UniqueConstraint(fields=('activity_schedule_cost_line_id', 'period', 'period_key'), name='uniq_costline_period')],
            },
        ),
    ]
