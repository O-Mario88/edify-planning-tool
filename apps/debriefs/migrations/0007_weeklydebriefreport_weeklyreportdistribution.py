        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("pl_team", "Program Lead Team"),
                            ("country", "Country"),
                            ("rvp", "Regional (RVP)"),
                            ("hr_people", "HR People Intelligence"),
                        ],
                        max_length=16,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["scope_kind", "scope_id", "week_start"],
                        name="weekly_debr_scope_k_3335cf_idx",
                    ),
                    models.Index(
                        fields=["status"], name="weekly_debr_status_924870_idx"
                    ),
                ],
                "constraints": [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="debriefs.weeklydebriefreport",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["report"], name="weekly_debr_report__257043_idx"
                    )
                ],
            },
        ),
