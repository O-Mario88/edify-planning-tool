    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["user"], name="refresh_tok_user_id_79bd41_idx")
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["staff"], name="staff_geogr_staff_i_c4118c_idx"
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["supervisor"], name="staff_super_supervi_8b1052_idx"
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("supervisee", "supervisor"),
                        name="uniq_supervisee_supervisor",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["user"], name="user_invita_user_id_9e4f4a_idx")
                ],
            },
        ),
    ]
