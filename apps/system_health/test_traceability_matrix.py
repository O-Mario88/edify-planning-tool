    ...
    def test_the_journeys_compute_the_displayed_metrics_their_pages_register(self):
        ...
        self.assertEqual(
            {key: len(value) for key, value in computing.items()},
            {
                ...
                "journey-09": 6,
                "journey-11": 8,
                # Sixty-eight since 2026-09-13: the Regional HR Director's
                # employee-relations, recruitment, onboarding and offboarding
                # registers count what they now measure (eight new tiles).
                "journey-13": 68,
