...
class Migration(migrations.Migration):
    dependencies = [
        (
            "schools",
            "0003_school_last_enrollment_date_uploadbatch_created_rows_and_more",
        ),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["planning_readiness"], name="school_plan_ready_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["account_owner_status"], name="school_owner_st_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["duplicate_status"], name="school_dup_status_idx"
            ),
        ),
    ]
