...
urlpatterns = [
    ...
    path("<str:user_id>/resend-invite", views.ResendInviteView.as_view(), name="resend-invite"),
    path("<str:user_id>/revoke-invite", views.RevokeInviteView.as_view(), name="revoke-invite"),
    ...
    path("<str:user_id>/force-password-reset", views.ForcePasswordResetView.as_view(), name="force-password-reset"),
]
