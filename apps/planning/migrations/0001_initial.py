    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status"], name="monthly_pla_status_34ed38_idx"
                    ),
                    models.Index(
                        fields=["owner_staff_id"], name="monthly_pla_owner_s_d6d62c_idx"
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["plan"], name="monthly_pla_plan_id_114a25_idx")
                ],
            },
        ),
    ]
