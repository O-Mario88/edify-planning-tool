...
2026-09-23 it is its own page, /cluster-oversight/, and they keep these pages
for the plan itself. Widening a
...
class TheReadingRolesStillReachThePagesTest(TestCase):
    ...
    def test_ia_reaches_cluster_oversight_on_its_own_page(self):
        response = self._get(self.ia, "/cluster-oversight/")
