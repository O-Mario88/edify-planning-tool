...
CATALOGUE_ITEMS = [
    _item(
        ...
        intervention=I.LEARNING_ENVIRONMENT,
    ...
    _item(
        ...
        Delivery.CLUSTER_TRAINING,
        ActivityType.CLUSTER_TRAINING,
        intervention=I.FINANCIAL_HEALTH,
    ...
    _item(
        ...
        Delivery.CLUSTER_TRAINING,
        ActivityType.CLUSTER_TRAINING,
        intervention=I.GOVERNMENT_REQUIREMENT,
        cluster=True,
        school=False,
    ...
    _item(
        ...
        Delivery.CLUSTER_TRAINING,
        ActivityType.CLUSTER_TRAINING,
        intervention=I.EXPOSURE_TO_WORD_OF_GOD,
        cluster=True,
        school=False,
    ),
    _item(
