...
urlpatterns = [
    ...
    path(
        ...
        views.LeadershipInsightView.as_view(),
        name="insight",
    ),
    path(
        "insight/<str:insight_id>/memo",
        views.LeadershipInsightMemoView.as_view(),
        name="memo",
    ),
    path(
        "insight/<str:insight_id>/review",
        views.LeadershipInsightReviewView.as_view(),
        name="review",
    ),
    path(
        "insight/<str:insight_id>/note",
        views.LeadershipInsightNoteView.as_view(),
        name="note",
    ),
]
