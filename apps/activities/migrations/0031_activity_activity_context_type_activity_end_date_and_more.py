...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('activities', '0030_remove_activityschedulecostline_uniq_cost_component_per_activity_and_more'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='activity',
            name='event_district',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='programme_activities', to='geography.district'),
        ),
        migrations.AddField(
            model_name='activity',
