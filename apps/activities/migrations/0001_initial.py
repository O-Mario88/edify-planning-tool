...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "delivery_type",
                    models.CharField(
                        choices=[("staff", "Staff"), ("partner", "Partner")],
                        default="staff",
                        max_length=16,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="schedule_cost_lines",
                        to="activities.activity",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            model_name="activity",
            index=models.Index(
                fields=["responsible_staff_id"], name="activity_respons_711310_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activity",
        ...
        migrations.AddIndex(
            model_name="activity",
            index=models.Index(
                fields=["scheduled_date"], name="activity_schedul_398a42_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activity",
            index=models.Index(
                fields=["assigned_partner_id"], name="activity_assigne_f20ef6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activity",
            index=models.Index(
                fields=["ia_verification_status", "payment_status"],
                name="activity_ia_veri_4001c9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="activity",
            index=models.Index(
                fields=["evidence_status"], name="activity_evidenc_78c12a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activityschedulecostline",
            index=models.Index(
                fields=["activity"], name="activity_sc_activit_1991a7_idx"
            ),
        ),
    ]
