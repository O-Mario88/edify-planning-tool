...
class CostSetting(TimeStampedModel):
    ...
    is the CD-controlled Minimum Viable Cost consumed by staff planning and
    funding calculations; legacy rows fall back to ``unit_cost`` until it is
    configured. Both are integer UGX to avoid float rounding."""
