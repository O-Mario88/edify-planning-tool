...
class AdminBudgetAllocationService:
    ...
    def get_admin_budget_allocation(month_num: int, fy: str) -> dict:
        ...
        planned_total = sum(line.total_cost for line in lines)
        ...
        for line in lines:
            serialized_lines.append(
                {
                    "id": line.id,
                    "cost_category": line.cost_category.replace("_", " ").title(),
                    "description": line.description,
                    "quantity": float(line.quantity),
                    "unit_cost": line.unit_cost,
                    "total_cost": line.total_cost,
                    "justification": line.justification or "None",
                    "created_by": line.created_by_user_id,
