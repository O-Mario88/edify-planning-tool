...
class SecondaryDistrictGroup(TimeStampedModel):
    ...
    status = models.CharField(
        max_length=16,
        choices=SecondaryDistrictGroupStatus.choices,
...
class SecondaryDistrictGroupMember(TimeStampedModel):
    ...
    group = models.ForeignKey(
        SecondaryDistrictGroup, on_delete=models.CASCADE, related_name="members"
    )
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, related_name="secondary_group_memberships"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["group", "district"], name="uniq_secondary_group_district"
            ),
        ]
