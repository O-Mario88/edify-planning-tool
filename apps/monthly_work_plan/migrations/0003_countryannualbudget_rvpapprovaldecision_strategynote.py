    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('submitted_to_rvp', 'Submitted to RVP'), ('approved_by_rvp', 'RVP Approved'), ('returned_by_rvp', 'Returned by RVP')], default='draft', max_length=32)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status'], name='country_ann_status_b958f3_idx')],
                'constraints': [models.UniqueConstraint(fields=('country_id', 'fy'), name='uniq_country_annual_fy')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['decision_type', 'subject_id'], name='rvp_approva_decisio_06a1af_idx')],
            },
        ),
        migrations.CreateModel(
            name='StrategyNote',
            fields=[
                ...
                ('responsible_cd_id', models.CharField(blank=True, max_length=30, null=True)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status', 'responsible_cd_id'], name='rvp_strateg_status_b59354_idx')],
            },
        ),
    ]
