...
// NOTE: the legacy Core School candidate workflow (coreSchoolCandidates,
// ssaVerificationTodos, ssaCoreCandidateSummary and their CS-* fabricated ids)
// has been retired. Core candidates are now derived live from the School
// Directory + SSA snapshots in the unified model — see src/lib/core/*.
