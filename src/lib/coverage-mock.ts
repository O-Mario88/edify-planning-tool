...
export const partnerCoverageRows: PartnerCoverageRow[] = [
  ...
  buildPartner({ id: "PRT-003", name: "Olive Children's School",     cert: "Certified",   region: "East",  districts: ["Mukono", "Buikwe"],          spec: "Discipleship",              capacity: 72, assigned: 28, highRisk: 6,  completed: 16, verified: 16, passRate: 100, sf: 87 }),
