...
export const dataTemplates: DataTemplate[] = [
  ...
  // sheet. Everything the planning engine needs flows from these three.
  {
    ...
    description: "Onboard schools into the planning engine — who owns them, where they are, and their current size. One row per school.",
    requiredColumns: [
      "Account Owner",
      "School ID",
      "School Name",
    ...
    validationRules: [
      ...
      "Last Date of Enrolment must be a valid date",
    ],
    createdBy: "Edify HQ",
  ...
  },
  {
    ...
    description: "Upload a school's SSA assessment. The fiscal year and quarter are derived automatically from the SSA Date. One row per assessment.",
    requiredColumns: [
      "School ID",
      "SSA Date",
    ...
    exampleRows: [
      {
        ...
        "Fees/Budget and Accounts": 6,
        "Government Requirement": 7,
        "Leadership Best Practice": 8,
        "Learning Environment": 6,
        "Teaching Environment": 7,
    ...
    validationRules: [
      ...
      "SSA Date must be a valid date — FY and quarter are derived from it",
