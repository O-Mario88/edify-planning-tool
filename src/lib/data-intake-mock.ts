...
export const dataImportBatches: DataImportBatch[] = [
  ...
  { id: "imp-9", templateId: "tpl-school-onboarding",dataType: "School Register",      sourceFileName: "SchoolRegister_June2026_Batch2.xlsx", uploadedBy: "Grace Alimo", uploadedAt: "Jun 28, 2026 · 14:00", status: "Validated", totalRows: 3, validRows: 3, errorRows: 0, warningRows: 0, validationSummary: { missingRequiredFields: 0, duplicateRecords: 0, invalidMappings: 0, warnings: 0 } },
];
