      ...
      <div className="w-full max-w-[440px] rounded-3xl border border-[var(--color-edify-border)] bg-white shadow-[0_24px_60px_rgba(15,23,32,0.10)] p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-3.5" noValidate>
          ...
          <button
            ...
            disabled={submitting}
            className={cn(
              "w-full h-11 rounded-xl bg-[var(--color-edify-primary)] hover:bg-[var(--color-edify-dark)] text-white font-bold text-body-lg inline-flex items-center justify-center gap-2 transition-colors",
