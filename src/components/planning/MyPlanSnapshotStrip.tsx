...
const TONE: Record<SnapshotTone, { icon: string; tile: string }> = {
  emerald: { icon: "bg-emerald-100 text-emerald-700",     tile: "border-emerald-100 hover:border-emerald-300" },
  sky:     { icon: "bg-sky-100 text-sky-700",             tile: "border-sky-100 hover:border-sky-300" },
  amber:   { icon: "bg-amber-100 text-amber-700",         tile: "border-amber-100 hover:border-amber-300" },
  rose:    { icon: "bg-rose-100 text-rose-700",           tile: "border-rose-100 hover:border-rose-300" },
  violet:  { icon: "bg-violet-100 text-violet-700",       tile: "border-violet-100 hover:border-violet-300" },
  slate:   { icon: "bg-slate-100 text-slate-500",         tile: "border-slate-200 hover:border-slate-300" },
};
