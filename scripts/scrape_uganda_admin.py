...
from django.db import transaction  # noqa: E402 — deliberate late import (see module layout)
from apps.geography.models import Region, District, SubCounty, GeographyAlias  # noqa: E402 — deliberate late import (see module layout)
...
OUTPUT_CSV = DJANGO_ROOT / "uganda_complete_administrative_mapping.csv"
